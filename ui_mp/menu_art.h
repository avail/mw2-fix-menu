...
// also widescreen needs major fixing i THINK.
...
#define HIGHLIGHT_BORDER 5 // WINDOW_BORDER_RAISED

#define HIGHLIGHT_SHADER "menu_setting_selection_bar"
...
//e.g 	CHOICE_DVARLIST( 25, "@MENU_VOICECHAT_LEVEL_INDICATOR", "", 8, ownerDraw 265, ; )
...
// needs fixing so text shows on top of button image and i have no clue, well it works at least just needs highlighting options.
// due to background/highlight is showing with focus and is permanent. 
#define CHOICE_BUTTON_BG( itemIndex ) \
#define CHOICE_BUTTON_BG_VIS( itemIndex, 1 )

#define CHOICE_BUTTON_BG_VIS( itemIndex, visArg ) \
		itemDef \
		{ \
			style 3 \
			rect CHOICE_ORIGIN( itemIndex ) ( CHOICE_SIZE_X + CHOICE_CAPTION_OFFSET ) CHOICE_SIZE_Y 0 0 \
